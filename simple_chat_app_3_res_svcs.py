...
openai_apikey_help = "Acquire a "key of your own at https://platform.openai.com/account/api-keys." #ould like to contact us for help please do so at techsupport@williamwcollinsjr.com"
