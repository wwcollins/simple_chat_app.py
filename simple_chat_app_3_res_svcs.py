...
openai_apikey_help = "After you have signed up for an OpenAi account you can acquire a "key of your own at https://platform.openai.com/account/api-keys.  Simply Paste it into this box and press enter.  The key will be good for that session." If you would like to contact us for help please do so at techsupport@williamwcollinsjr.com"
